            ...
            <Container component="registration-main" maxWidth="xs">
                ...
                <div className='paper'>
                    ...
                    <div className='progressBar'>
                        ...
                        <form className='registration-form' className='form' onSubmit={this.submitHandler} xs={12} sm={12}>
                            <Grid className='FirstLine'>
                                ...
                                <FormControl component="gender-radio">
                                    ...
                                    <RadioGroup defaultValue="female" aria-label="gender" name="gender">
                                        <FormControlLabel className='radioChoice' value="female" control={<Radio />} label="Female" onChange={this.changeHandler} />
                                        <FormControlLabel className='radioChoice' value="male" control={<Radio />} label="Male" onChange={this.changeHandler} />
                                        <FormControlLabel className='radioChoice' value="other" control={<Radio />} label="Other" onChange={this.changeHandler} />
                                    </RadioGroup>
                                </FormControl>
                        ...
                        <Grid className='login'>Already have an account? 
